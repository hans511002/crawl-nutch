...
//	  }
//	 String [] serverUrls = conf.get(ElasticConstants.SERVER_URL, "192.168.10.101").split(",");
//	 for(String url:serverUrls){
//		 if(null != url && !url.trim().isEmpty()){
//			 client.addTransportAddress(new InetSocketTransportAddress(url.trim(), 9300));
//		 }
//	 }
//	 this.client = client;
    
     bulk = client.prepareBulk();
     defaultIndex = conf.get(ElasticConstants.INDEX, "index");
     maxBulkDocs = conf.getInt(ElasticConstants.MAX_BULK_DOCS, DEFAULT_MAX_BULK_DOCS);
     maxBulkLength = conf.getInt( ElasticConstants.MAX_BULK_LENGTH, DEFAULT_MAX_BULK_LENGTH);
  }
