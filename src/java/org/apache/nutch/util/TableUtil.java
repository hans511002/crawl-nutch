...
public class TableUtil {
	...
	public static int indexOf(String str, String target, boolean ig) {
		return indexOf(str.toCharArray(), 0, str.length(), target.toCharArray(), 0, target.length(), 0, ig);
	}

	public static int indexOf(String str, String target, int fromIndex, boolean ig) {
		return indexOf(str.toCharArray(), 0, str.length(), target.toCharArray(), 0, target.length(), fromIndex, ig);
	}

	public static int indexOf(char[] source, int sourceOffset, int sourceCount, char[] target, int targetOffset, int targetCount,
			int fromIndex, boolean ig) {
