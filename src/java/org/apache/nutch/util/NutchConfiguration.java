...
/**
 * Utility to create Hadoop {@link Configuration}s that include Nutch-specific resources.
 */
public class NutchConfiguration {
	...
	public static Configuration create() {
		...
		Properties pro = DataStoreFactory.createProps();
		for (Object key : pro.keySet()) {
			conf.set(key.toString(), pro.getProperty(key.toString()));
		}
		return conf;
	}
	 ...
	 *            if true, then first <code>nutch-default.xml</code>, and then <code>nutch-site.xml</code> will be loaded prior to applying
