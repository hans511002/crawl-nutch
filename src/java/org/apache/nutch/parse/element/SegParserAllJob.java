...
public class SegParserAllJob extends NutchTool implements Tool {

	public static final Logger LOG = LoggerFactory.getLogger(SegParserAllJob.class);
	...
	public static class SegmentParserAllMapper extends GoraMapper<String, WebPage, Text, WebPage> {
		...
		String getParseStatus(Context context) {
			return "read:" + rowCount + " needed parsed:" + needParseCount + " <br/>更新时间：" + (new Date().toLocaleString());
		}
	...
	public SegParserAllJob() {

	}

	public SegParserAllJob(Configuration conf) {
		setConf(conf);
	}
	...
	public static void main(String[] args) throws Exception {
		final int res = ToolRunner.run(NutchConfiguration.create(), new SegParserAllJob(), args);
		System.exit(res);
	}
}
