...
public class SubAttrListRule extends ExprCalcRule {
	...
	/**
	 * subattrlist:开始字符~结束字符~块正则~块取值~rowkey 正则~rowkey取值 [~rexgex~substitution~isDelTag~colname]
	 ...
	 */
	public SubAttrListRule(String rule) throws Exception {
