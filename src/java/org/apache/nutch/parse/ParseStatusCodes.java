...
public interface ParseStatusCodes {
	...
	public static final String[] majorCodes = { "notparsed", "success", "failed", "nocontent" };
	...
	/**
	 * Parsing failed. Other related parts of the content are needed to complete parsing. The list of URLs to missing parts may be provided
	 * in arguments. The Fetcher may decide to fetch these parts at once, then put them into Content.metadata, and supply them for
	 * re-parsing.
	 */
