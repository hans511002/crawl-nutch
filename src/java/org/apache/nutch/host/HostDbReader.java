...
public class HostDbReader extends Configured implements Tool {
	...
	private void read(String key) throws ClassNotFoundException, Exception {

		DataStore<String, Host> datastore = StorageUtils.createWebStore(getConf(), String.class, Host.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(NutchConfiguration.create(), new HostDbReader(), args);
		System.exit(res);
	}
