...
public class CrawlTest {
	public static final Logger LOG = LoggerFactory.getLogger(CrawlTest.class);
	static WebPage page;
	static String url;
	...
	public static void main(String[] args) throws NumberFormatException, Exception {
		...
		String startUrlKey = "http://weibo.com/u/";
		String endUrlKey = "http://weibo.com/v/";// startUrlKey;// "http://tech.qq.com/a/20130824/004772.htm";
		...
		while (rs.next()) {
			...
			if (outlinks != null) {
				...
				for (Entry<Utf8, Utf8> e : outlinks.entrySet()) {
					...
					store.put(key, subpage);
					System.out.println("WebPage outlink==" + e.getKey() + " " + olurl);
				}
			}
			// update self
