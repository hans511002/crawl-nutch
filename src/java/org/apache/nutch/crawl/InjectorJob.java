...
/**
 * This class takes a flat file of URLs and adds them to the of pages to be crawled. Useful for bootstrapping the system. The URL files
 * contain one URL per line, optionally followed by custom metadata separated by tabs with the metadata key separated from the corresponding
 * value by '='. <br>
