...
public enum Mark {
	INJECT_MARK("_injmrk_"), GENERATE_MARK("_gnmrk_"), FETCH_MARK("_ftcmrk_"), PARSE_MARK("__prsmrk__"), UPDATEDB_MARK("_updmrk_"), INDEX_MARK(
			"_idxmrk_"), BETCH_MARK("_btmrk_"), SEGMENT_MARK("_sgmrk_"), ROOTID_MARK("rid"), MEDIATYPEID_MARK("mtid"), MEDIALEVELID_MARK(
			"mlid"), TOPICID_MARK("tpid"), AREAID_MARK("zid");
