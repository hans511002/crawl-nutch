...
public class ParseStatus extends PersistentBase {
	public static final Schema _SCHEMA = Schema
			.parse("{\"type\":\"record\",\"name\":\"ParseStatus\",\"namespace\":\"org.apache.nutch.storage\","
					+ "\"fields\":[{\"name\":\"majorCode\",\"type\":\"int\"}," + "{\"name\":\"minorCode\",\"type\":\"int\"},"
	...
	public String toString() {
		...
		return "majorCode:" + majorCode + " minorCode:" + minorCode + " args:" + tmp;
	}
