...
public class WebPage extends PersistentBase implements java.io.Serializable {
	private static final long serialVersionUID = -4590096852984332968L;
	public static final Schema _SCHEMA = Schema
			.parse("{\"type\":\"record\",\"name\":\"WebPage\",\"namespace\":\"org.apache.nutch.storage\",\"fields\":"
	...
	public static enum Field {
		BASE_URL(0, "baseUrl"), STATUS(1, "status"), FETCH_TIME(2, "fetchTime"), PREV_FETCH_TIME(3, "prevFetchTime"), FETCH_INTERVAL(4,
				"fetchInterval"), RETRIES_SINCE_FETCH(5, "retriesSinceFetch"), MODIFIED_TIME(6, "modifiedTime"), PROTOCOL_STATUS(7,
				"protocolStatus"), CONTENT(8, "content"), CONTENT_TYPE(9, "contentType"), PREV_SIGNATURE(10, "prevSignature"), SIGNATURE(
				11, "signature"), TITLE(12, "title"), TEXT(13, "text"), PARSE_STATUS(14, "parseStatus"), SCORE(15, "score"), REPR_URL(16,
				"reprUrl"), HEADERS(17, "headers"), OUTLINKS(18, "outlinks"), INLINKS(19, "inlinks"), MARKERS(20, "markers"), METADATA(21,
				"metadata"), CRAWLTYPE(22, "crawlType"), CONFIGURL(23, "configUrl");
		private int index;
		private String name;
	...
	float score;
	Utf8 reprUrl;
	Map<Utf8, Utf8> headers;
	Map<Utf8, Utf8> outlinks;
	Map<Utf8, Utf8> inlinks;
	Map<Utf8, Utf8> markers;
	Map<Utf8, ByteBuffer> metadata;
	int crawlType;
	Utf8 configUrl;

	public UrlNodeConfig nodeConfig;
	public HashMap<String, Integer> wordPre = null;
	...
	public void setHeaders(Map<Utf8, Utf8> headers) {
		this.headers = headers;
	}

	public void setOutlinks(Map<Utf8, Utf8> outlinks) {
		this.outlinks = outlinks;
	}

	public void setInlinks(Map<Utf8, Utf8> inlinks) {
		this.inlinks = inlinks;
	}

	public void setMarkers(Map<Utf8, Utf8> markers) {
		this.markers = markers;
	}

	public void setMetadata(Map<Utf8, ByteBuffer> metadata) {
	...
	public void setCrawlType(int crawlType) {
		put(22, crawlType);// this.crawlType = crawlType;
	}
	...
	public void setConfigUrl(Utf8 configUrl) {
		put(23, configUrl);// this.configUrl = configUrl;
	}
}
