...
/**
 * A DataStore implementation for RDBMS with a SQL interface. SqlStore uses the JOOQ API and various JDBC drivers to communicate with the
 * DB. Through use of the JOOQ API this SqlStore aims to support numerous SQL database stores namely; DB2 9.7 Derby 10.8 H2 1.3.161 HSQLDB
 * 2.2.5 Ingres 10.1.0 MySQL 5.1.41 and 5.5.8 Oracle XE 10.2.0.1.0 and 11g PostgreSQL 9.0 SQLite with inofficial JDBC driver v056 SQL Server
 * 2008 R8 Sybase Adaptive Server Enterprise 15.5 Sybase SQL Anywhere 12
 * 
 * This DataStore is currently in development, and requires a complete re-write as per GORA-86 Please see
...
public class SqlStore<K, T extends PersistentBase> extends DataStoreBase<K, T> {
	 ...
	 */
	public void setObject(PreparedStatement statement, int index, Object object, Schema schema, Column column) throws SQLException,
			IOException {
		// TODO
	}

	protected <V> void setObject(PreparedStatement statement, int index, V object, int objectType, Column column) throws SQLException,
			IOException {
