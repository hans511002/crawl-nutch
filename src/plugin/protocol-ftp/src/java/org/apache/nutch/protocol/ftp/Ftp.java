 ...
 * 
 * Configurable parameters are defined under "FTP properties" section in ./conf/nutch-default.xml or similar.
 * 
 * @author John Xing
 ***********************************/
public class Ftp implements Protocol {
	...
	public static void main(String[] args) throws Exception {
		...
		Content content = ftp.getProtocolOutput(urlString, new WebPage()).getContent();
