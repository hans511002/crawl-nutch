...
public class HBaseColumn {
	...
	public HBaseColumn(byte[] family, byte[] qualifier) {
		...
		this.qualifier = qualifier == null ? null : Arrays.copyOf(qualifier, qualifier.length);
	}
	...
	public String toString() {
		return "HBaseColumn [family=" + Arrays.toString(family) + ", qualifier=" + Arrays.toString(qualifier) + "]";
	}
