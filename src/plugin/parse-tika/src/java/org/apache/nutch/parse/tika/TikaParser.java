...
public class TikaParser implements org.apache.nutch.parse.Parser {
	...
	public Parse getParse(String url, WebPage page) {
		...
		for (String tikaMDName : TikaMDNames) {
			...
			page.putToMetadata(new Utf8(tikaMDName), ByteBuffer.wrap(Bytes.toBytes(tikamd.get(tikaMDName))));
		}
	...
	private void getTextHelper(StringBuffer sb, Node node) {
		getTextHelper(sb, node, false, false);
	}

	// 使用递归分段
	private boolean getTextHelper(StringBuffer sb, Node node, boolean parIsPause, boolean priIsPause) {
		if (node == null)
			return false;
		...
		if ("script".equalsIgnoreCase(nodeName)) {
			...
			return false;
		} else if (nodeName.toUpperCase().equals("P") || nodeName.toUpperCase().equals("DIV") || nodeName.toUpperCase().equals("SPAN")) {
			curIsPause = true;
		}
