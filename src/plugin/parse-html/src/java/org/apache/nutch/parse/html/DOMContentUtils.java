...
public class DOMContentUtils {
	...
	/**
	 * This method takes a {@link StringBuilder} and a DOM {@link Node}, and will append all the content text found beneath the DOM node to
	 * the <code>StringBuilder</code>.
	 * 
	 * <p>
	 * 
	 * If <code>abortOnNestedAnchors</code> is true, DOM traversal will be aborted and the <code>StringBuffer</code> will not contain any
	 * text encountered after a nested anchor is found.
	 * 
	 * <p>
	 * 
	...
	/**
	 * This method takes a {@link StringBuffer} and a DOM {@link Node}, and will append the content text found beneath the first
	 ...
	 * <p>
	 * If the taget contains params (i.e. ';xxxx') information then the target params information is assumed to be correct and any base
	 * params information is ignored. If the base contains params information but the tareget does not, then the params information is moved
	 * to the target allowing it to be correctly determined by the java.net.URL class.
	 * 
	 * @param base
	 *            The base URL.
	 * @param target
	 ...
	 * <p>
	 * 
	 * Links without inner structure (tags, text, etc) are discarded, as are links which contain only single nested links and empty text
	 * nodes (this is a common DOM-fixup artifact, at least with nekohtml).
	 */
