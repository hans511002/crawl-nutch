...
/**
 * Class for parsing META Directives from DOM trees. This class handles specifically Robots META directives (all, none, nofollow, noindex),
 * finding BASE HREF tags, and HTTP-EQUIV no-cache instructions. All meta directives are stored in a HTMLMetaTags instance.
 */
public class HTMLMetaProcessor {
	...
	/**
	 * Sets the indicators in <code>robotsMeta</code> to appropriate values, based on any META tags found under the given <code>node</code>.
	 */
