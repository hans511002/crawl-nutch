 ...
 * 
 * Configurable parameters are defined under "FILE properties" section in ./conf/nutch-default.xml or similar.
 * 
 * @author John Xing
 ***********************************/
public class File implements Protocol {
	...
	public static void main(String[] args) throws Exception {
		...
		Content content = file.getProtocolOutput(urlString, new WebPage()).getContent();
