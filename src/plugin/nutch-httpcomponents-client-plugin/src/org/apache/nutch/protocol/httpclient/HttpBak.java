 ...
 * @author Susam Pal
 */
public class HttpBak extends HttpControl {

  public static final Logger LOG = LoggerFactory.getLogger(HttpBak.class);
...
//    super(LOG);
  ...
  protected Response getResponse(URL url, CrawlDatum datum, boolean redirect)
    ...
    return new HttpResponse(null, url, datum, redirect);
  }
