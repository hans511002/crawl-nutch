...
public class Http
{
	...
	public Http(HttpControl httpControl)
	{
	...
	{
		return httpControl.getUseHttp11();
	}

	public int getMaxContent()
	{
		return httpControl.getMaxContent();
	}

	public byte[] processGzipEncoded(byte[] content, URL url) throws IOException
	{
		return httpControl.processGzipEncoded(content, url);
	}

	public byte[] processDeflateEncoded(byte[] content, URL url) throws IOException
	{
		return httpControl.processGzipEncoded(content, url);
	}
}
