 ...
 */
@Immutable
public class HttpClientRedirectStrategy implements RedirectStrategy {
    ...
    public HttpClientRedirectStrategy() {
        super();
    }
    ...
    public boolean isRedirected(
        ...
        if ((statusCode >= 300 && statusCode < 400 && statusCode != 304) || statusCode == 401) {
            return false;
        }
